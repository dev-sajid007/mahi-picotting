                    ...
                    <div class="card-body">
                        <div class="breadcrumb-five">
                            <ul class="breadcrumb">
                                ...
                                <li class="active mb-2"><a href="javscript:void(0);">Manage Employee</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="progress-order-header">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-12">
                                        <h6><i class="fas fa-user-tag"></i> Employee Management </h6>
                                    </div>
                                    <div class="col-md-6 pl-0 col-sm-6 col-12 text-right">
                                        <a href="{{route('app.employees.create')}}"  class="btn-shadow mr-3 btn btn-dark">
                                    ...
                                    @foreach($employees as $key => $employee)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if(Auth::user()->hasPermission('app.employees.edit'))
                                                    <a href="{{route('app.employees.edit',$employee->id)}}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
                                                @endif
                                                @if(Auth::user()->hasPermission('app.employees.delete'))
                                                    <a id="delete" href="{{route('app.employees.delete',$employee->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-trash-alt"></i></a>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
