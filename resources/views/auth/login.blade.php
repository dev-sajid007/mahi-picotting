                    ...
                    <form method="POST" action="{{ route('login') }}" class="text-left">
                        ...
                        <div class="form">
                            <div id="username-field" class="field-wrapper input">
                                ...
                                <input id="email" type="email" placeholder="Email" class="form-control @error('email') is-invalid @enderror" name="email" value="admin@gmail.com" required autocomplete="email" autofocus>
                                @error('email')
                            ...
                            <div id="password-field" class="field-wrapper input mb-2">
                                ...
                                <input id="password" name="password" type="password" placeholder="Password" value="123" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
...
<script src="{{asset("assets/backend/js/authentication/form-2.js")}}"></script>
